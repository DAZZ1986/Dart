...
void main() {
  ...
  //final and const - обе запрещают изменять переменную
  //const - более трогая, значение не будет изменяться на этапе
  //компиляции и в рантайме.
  //final - менее строгая, оно позволяет вычислуть и установить
  ...
  //itarationNUmber3 и только в след строке она
  //увеличилась.
  print('==========');
  //_________________________________________________________
  ...
  //попытаться запустить с программу с пустой переменной.
  //?
  //print(number77.isNegative); //тут ошибка, тк number7 = null
  //print(number77?.isNegative);  //тут удалось избежать ошибки в консоли
  //??
  //print(number77 ?? 1); //если number77=null, тол присвоится 1, а
  //если number77 не null, то правая часть выполнена не будет ?? 1.
  //??=
  //number77 ??= 1; //аналогично, есль в number77 null то присвоится 1,
  //если в ней не null, то 1 присвоена не будет.
